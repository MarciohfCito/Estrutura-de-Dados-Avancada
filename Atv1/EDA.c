...
// OBS: nao consegui fazer a tempo o codigo para grafos nao direcionados e implementar a biblioteca Python.h
// para fazer a implementacao da API, porem os dois codigos estao funcionando separadamente
#include <Python.h>
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
    ...
    do {
        ...
        switch (o){
            ...
            case 7:
                printf("\nteste");
                Py_Initialize();
                PyRun_SimpleString("import grafos");
                Py_Finalize();
                break;
        }
    }while (o!=8);
